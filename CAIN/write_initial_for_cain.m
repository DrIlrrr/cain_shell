...
fprintf(fileID,'       RAYLEIGH=(rayl,rayl), SIGT=sigt, GCUTT=ntcut, STOKES=(0,0,0),\n');
...
fprintf(fileID,' \n');
fprintf(fileID,' PUSH  Time=(-ntcut*(sigt+sigz),ntcut*(sigt+sigz),250);\n');
